<%@ include file="/init.jsp" %>
    ...
    <portlet:renderURL var="renderDarkorchid">
        <portlet:param name="buttonBgColor" value="darkorchid" />
    </portlet:renderURL>


        <a class="btn" style="<%=buttonStyle%>" href="<%=renderDarkorchid%>">Set dark orchid</a> 
